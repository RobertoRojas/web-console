...
function showImage(image) {
    document.getElementById("shell").innerHTML = document.getElementById("shell").innerHTML + "<div class='image' style='width: " + image.width + "em;height: " + image.height + "em;'><div class='image_picture' style='background-image: url(\"" + image.value + "\");'></div><div class='image_filter'><span>[" + image.identifier + "]</span></div></div>";
}
